<template>
    ...
    <div class="app-sidebar">
          ...
          <router-link to="/creater" class="app-sidebar-link active"> 
...
<!--        </router-link>-->
        ...
        <router-link to="/amplifier" class="app-sidebar-link active">
          <div class="svg_content">
        ...
        <router-link to="/temperature" class="app-sidebar-link active">
          <div class="svg_content">
