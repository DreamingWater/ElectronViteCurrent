<template>
  <div :id="`${childname}-switch`"  class="switch">
    <div class="switch__1">
      <input :id="`${childname}-switch-1`" type="checkbox" v-model="switchvalue" @change="transValue">
...
const props = defineProps({
  ...
  defaultSwitchValue: { type: Boolean, default: false }, // Add this line
});

const switchvalue = ref(props.defaultSwitchValue); // Use the default value here
